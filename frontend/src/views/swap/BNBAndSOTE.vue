        ...
        <el-col :xs="24" :sm="11">
          <el-card class="box-card-from">
            <div slot="header" class="clearfix">
              <span>Amount</span>
              <el-link v-if="showReset" @click="form.amount='0'" type="primary" style="float: right; padding: 3px 0"
                       :underline="false">Reset
              </el-link>
              <el-link v-else @click="form.amount=balanceValue.toString()" type="success" :underline="false"
